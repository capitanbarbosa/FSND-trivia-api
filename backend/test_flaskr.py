...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_delete_question(self):
        question = Question(question='question1', answer='answer1', difficulty=1, category=1)
        question.insert()
    ...
    def test_422_deleted_question_not_exist(self):
        res = self.client().delete('/questions/null')
        data = json.loads(res.data)
